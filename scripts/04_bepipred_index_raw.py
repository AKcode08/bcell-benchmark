...
MODEL = "BepiPred2" # can replace with BepiPred3 if needed
EPITOPE_TYPE = "linear"
THRESHOLD = 0.50
...
def usage():
    print("Usage: python scripts/04_bepipred_index_raw.py <ORG_CODE>", file=sys.stderr)
    sys.exit(1)
...
def main():
    ...
    outdir = Path(f"outputs/bepipred2/{org}/linear")
    raw = outdir / "raw_output.csv"
    out = outdir / "bepipred2_indexed.csv"
